...
public class BeanUtils {
    ...
    //   ------------------------------------------- lambda -------------------------------------------
    /**
     * 简化 ele -> beanUtils.tran.... 动作
     * @param targetType 目标类型
     * @param <T> 原始类型
     * @param <R> 目标类型
     * @return 目标对象
     */
    public static <T,R> Function<T,R> doElementTypeMap(Class<R> targetType) {
        return ele -> BeanUtils.transformFrom(ele,targetType);
    }
     ...
     * @return 目标对象
     */
    public static <T,R> Function<T,R> doElementTypeMap(Class<R> targetType, Consumer<R> consumer) {
        return ele -> {
            R r = BeanUtils.transformFrom(ele, targetType);
            consumer.accept(r);
            return r;
        };
    }
